...
if(isServer) then 
{
	...
	switch (true) do 
	{
		...
		{
			[[1,format["VICTIME ROUTIERE: %1 à tuer %2 avec son %3",_killer getVariable["realname",name _killer], _victim getVariable["realname",name _victim], _vehName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
		};
