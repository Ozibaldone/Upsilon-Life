...
life_respawn_timer = 0.40; //Scaled in minutes
life_knockout = false;
...
__CONST__(life_impound_boat,4500);
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",8000],["blastingcharge",10000],["boltcutter",500]];
