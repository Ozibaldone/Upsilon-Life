...
switch (_filter) do
{
	...
	case 3:
	{
		[
			...
			["V_BandollierB_rgr",nil,3000],
			["V_PlateCarrier1_blk",nil,3000],
			["V_Chestrig_blk",nil,3000],
			["V_TacVestIR_blk",nil,3000],
			["V_TacVestCamo_khk",nil,3000],
			["V_HarnessO_brn",nil,3000],
			["V_HarnessOGL_brn",nil,3000],
			["_HarnessO_gry",nil,3000],
			...
			["V_PlateCarrier_Kerry",nil,3000],
			["V_PlateCarrierL_CTRG",nil,3000],
			["V_PlateCarrierH_CTRG",nil,3000],
