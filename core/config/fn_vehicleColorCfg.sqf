...
switch (_vehicle) do
{
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\teamrebelle\suv-tbs","reb"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		_ret = 
		[
			["textures\police\hummingbird.paa","cop"],
			...
			["textures\medic\helicopsecours.jpg","med"]
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\police\cop_hunter_red_front.jpg","cop","textures\police\cop_hunter_red_back2.jpg"],
