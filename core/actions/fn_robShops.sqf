...
_chance = random(100);
if(_chance < 50) then { hint "Le caissier avait une alarme secrete, la police arrive!"; [[1,format["ALERTE la Station service: %1 se fait braquer!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; }; //une chance sur 2 que la police sois contacter pendant le braquage
...
_pgText ctrlSetText format["Braquage en cour (1%1)...","%"];
